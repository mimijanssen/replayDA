...
ylabel("Rate of SWRs (SWR per minute)")
xlabel("Rest Session")
set(gca,'fontsize', 18)

set(gcf, 'renderer', 'painters');
cd ('C:\Users\mimia\OneDrive\Desktop\updated figures')
exportgraphics(gcf, 'SWR_freq.png', 'ContentType','vector');  % Export as PDF
hold off 
...
set(gcf, 'renderer', 'painters');
cd ('C:\Users\mimia\OneDrive\Desktop\updated figures')
exportgraphics(gcf, 'SWR_dur.png', 'ContentType','vector');  % Export as PDF
hold off 
