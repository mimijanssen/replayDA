...
median(nonan_Tbl.peak)
% standard error of the median
sigma_median = 1.253*std(nonan_Tbl.peak)/sqrt((size(nonan_Tbl.peak,1)))

%% Median across all mice
mousemean2 = [];
for i = 1:1:length(uni_mouse)
    mousemean = mean(nonan_Tbl(nonan_Tbl.mouse == categorical(uni_mouse(i)),"peak"));
    mousemean2 = [mousemean2; mousemean];
end

median(table2array(mousemean2))
sigma_median2 = 1.253*std(table2array(mousemean2))/sqrt(8)
