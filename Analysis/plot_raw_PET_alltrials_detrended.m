...
cd C:\Data\M383\2023-01-20_M383_rac_track;  LoadExpKeys; LoadMetadata;
cfg.fc = {'CSC30.ncs'};
...
for triali = 1:1:length(evt2_ordered) %(min(length(evt.t{1}),length(evt.t{2})))*2 %length(evt.t{1}) 40 for the color but 20 for the trial 
if mod (triali,2) == 0 
