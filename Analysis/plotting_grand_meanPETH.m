...
fiber_4 = mean([sess.mouse4.avg_fiber_pre ; sess.mouse4.avg_fiber_post]);
fiber_5 = mean([sess.mouse5.avg_fiber_pre ; sess.mouse5.avg_fiber_post]);
fiber_6 = mean([sess.mouse6.avg_fiber_pre ; sess.mouse6.avg_fiber_post]);
fiber_7 = mean([sess.mouse7.avg_fiber_pre ; sess.mouse7.avg_fiber_post]);
fiber_8 = mean([sess.mouse8.avg_fiber_pre ; sess.mouse8.avg_fiber_post]);
...
exportgraphics(gcf, 'Pretrack_PETH_ticks.eps', 'ContentType','vector');  % Export as PDF
