...
ProcPeakTbl.sleep = categorical(ProcPeakTbl.sleep);
...
lme_swrevt = fitlme(ProcPeakTbl,'Peak ~ sleep + swrID+ (1|mouseID) + (1|sess:mouseID)');%(ProcPeakTbl,'Peak ~ BeforeAfter + swrID + PrePost + (1|mouseID) + (1|sess)');
disp(lme_swrevt)
% AIC: 1.0814e+05 

lme_swrevt4 = fitlme(ProcPeakTbl,'Peak ~ BeforeAfter + sleep + swrID + (1|mouseID) + (1|sess:mouseID)');%(ProcPeakTbl,'Peak ~ BeforeAfter + swrID + PrePost + (1|mouseID) + (1|sess)');
disp(lme_swrevt4)
% AIC: 1.0802e+05
